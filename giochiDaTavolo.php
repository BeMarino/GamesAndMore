...
<?php	
	...
	$result=mysqli_query($db,"SELECT * from articoli WHERE categoria LIKE 'giochi da tavolo' AND InCatalogo=1 ");
...
<!-- NAVIGATION -->
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="giochiDaTavolo">Giochi da tavolo</a></li>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Giochi da tavolo</h3>
		...
		<div class="section">
			...
			<?php 						
					...
					echo'
					<div class="product" style="height:330px; width:151px ;float:left; ;margin-right:40px">
