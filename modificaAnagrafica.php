	...
	<div class="col-md-7">
		...
		<div style="margin-top:-20px; margin-right:100px">
			...
			<div class="form-group">
				<label>Nome</label>
				<input class="form-control" type="text"  id="NomeForm"  placeholder=<?php
			...
			<div class="form-group">
				<label>Cognome</label>
				<input class="form-control" type="text"  id="cognomeForm" placeholder=<?php
			...
			<div class="form-group">
				<label>Email</label>
				<input class="form-control" type="email"  id="emailForm" placeholder=<?php
			...
			<div class="form-group">
				<label>Paese</label>
				<input class="form-control" type="text"  id="paeseForm" placeholder=<?php
			...
			<div class="form-group">
				<label>Città</label>
				<input class="form-control" type="text"  id="cittàForm" placeholder=<?php
						echo $row['Citta'];
			...
			<div class="form-group">
				...
				<input class="form-control" type="text"  id="indirizzoForm" placeholder="<?php
						echo $row['Indirizzo'];
			...
			<div class="form-group">
				...
				<input class="form-control" type="text"  id="provinciaForm" placeholder=<?php
						echo $row['Provincia'];
			...
			<div class="form-group">
				<label>CAP</label>
				<input class="form-control" type="number"  id="capForm"  placeholder=<?php
						echo $row['Cap'];
			...
			<div class="form-group">
				...
				<select class="form-control"  id="domandaForm" >
			...
			<div class="form-group">
				...
				<input class="form-control" type="tel"  id="rispostaForm" placeholder=<?php
						echo $row['Risposta'];
			...
			<button type="submit" class="primary-btn order-submit"onClick=aggiornaProfilo(<?php echo $idUtente;?>)>Aggiorna Profilo</button>
	</div>
