...
<?php
	...
	if(isLoggedIn()){
		...
		$ord=mysqli_query($db,"SELECT  * from ordini WHERE idUtente=$idUtente GROUP BY idOrdine ORDER BY data DESC");
					...
					<?php if(isLoggedIn()){
						...
						<ul style="list-style-type:none;  margin-left:-150px;">
							...
							while($ordine=$ord->fetch_assoc()){
								...
								?>
							<li style="margin-bottom:10px;margin-top:30px;margin-left:125px"><div class="order-details" style="width:800px;heigth: 250px;">	
								...
								while($row=$res->fetch_assoc()) {
									...
									?><div><?php echo $quantita."x". $nome."&nbsp".$quantita*$row['prezzo_unita'].'&#8364'; ?></div><?php
								}
