...
<?php	
	...
	$result=mysqli_query($db,"SELECT * from articoli WHERE categoria LIKE 'gadget' AND InCatalogo=1");
...
<!-- NAVIGATION -->
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Gadget</h3>
		...
		<div class="section">
			...
			<?php 						
					...
					echo'
					<div class="product" style="height:355px; width:151px ;float:left; ;margin-right:40px">
