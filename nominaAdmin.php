...
?>
       ...
       <!-- BREADCRUMB -->
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Nomina nuovo admin</h3>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details" style="margin-top:-25px">
							...
							<div class="form-group">
								<select class="form-control" id="utente" required>
									<?php	
										$result = mysqli_query($db,"SELECT * from utenti where Admin=0");
						...
						<button Style="margin-left:390px; margin-top:-30px;margin-bottom:15px"  class="primary-btn order-submit" onClick=nominaAdmin(utente.id)>Nomina admin</button>
	...
	function nominaAdmin(emailUtente){
		...
		var email=document.getElementById(emailUtente).value;
		 ...
		 $.ajax({
		  type: "POST",
		  url: "nominaAdmin1.php",
		  data: ({email: email}),
		  success: function (result) {
			
			  if(result==1){
			  alert("Hai nominato un nuovo Admin!");
			  window.location="index.php"
			  }
			  else  if(result==2){
			  alert("Errore durante la richiesta");
			  window.location="nominaAdmin.php";
			  }
		  }, dataType: 'text'
		});
