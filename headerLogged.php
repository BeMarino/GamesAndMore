					...
					<div class="row">
						...
						<div class="col-md-3 clearfix" style="margin-top:15px">
							<div class="header-ctn">
								...
								<?php if(($_SERVER['REQUEST_URI']=="/progetto/areaPersonale.php")||($_SERVER['REQUEST_URI']=="/progetto/areaAdmin.php")){
										echo"<a style='margin-left:20px'><font color='red'><img src='./img/immagine.png'>".$_SESSION['user']['Nome']." ".$_SESSION['user']['Cognome']."</font></a>";
										}
									else echo "<a style='margin-left:20px' href='areaPersonale.php'><img src='./img/immagine.png'>
									<font color='white'> ".$_SESSION['user']['Nome']." ".$_SESSION['user']['Cognome']."</font></a>";
								?>
								<div class="dropdown">
								<?php if($_SERVER['REQUEST_URI']=='/progetto/carrello.php'){
									echo'<a style="margin-left:40px">
										...
										<div class="qty" id="totale" style="margin-right:30px">';echo $totale; echo'</div>
